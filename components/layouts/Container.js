                        ...
                        <div className="row" style={{
                            ...
                            <div className="col-xs-12 col-sm-8 col-md-12 col-lg-9" style={{
                                ...
                                <p className={layoutStyle.pIntro}>
                                    ...
                                    มหาวิทยาลัยเกษตรศาสตร์ (บางเขน) เกรดรวม 3.12 (Major พลังงาน)
                                    ...
                                    ทำงานเกี่ยวกับการโปรแกรมมิ่งครับ
                                    <br></br>
                                    <mark>
                                        <a style={{
                                            color:'#fff',
                                    ...
                                    <br></br>
                                    <mark>
                                    "ผมพร้อมที่จะเรียนรู้งานใหม่ การทำงานแบบต่างๆ รวมถึงภาษาใหม่ที่ไม่เคยศึกษา"
                                    </mark>
                                    <br></br>
                                </p>
                            </div>
